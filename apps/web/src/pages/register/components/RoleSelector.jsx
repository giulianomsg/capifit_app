...
const RoleSelector = ({ selectedRole, onRoleSelect, error, className = '' }) => {
  const roles = [
    {
      id: 'trainer',
      ...
      icon: 'Dumbbell',
      color: 'bg-primary',
      benefits: ['Gerenciar múltiplos clientes', 'Criar planos de treino', 'Acompanhar evolução', 'Chat direto com alunos'],
    },
    {
      id: 'client',
      name: 'Cliente',
      ...
      icon: 'User',
      color: 'bg-secondary',
      benefits: ['Treinos personalizados', 'Planos alimentares', 'Acompanhamento profissional', 'Suporte especializado'],
    },
  ];
  ...
  return (
    <div className={`space-y-4 ${className}`}>
      <div className="text-center mb-6">
        <h3 className="text-lg font-semibold text-foreground mb-2">Como você deseja usar o CapiFit?</h3>
        <p className="text-sm text-muted-foreground">Escolha o perfil que melhor se adequa às suas necessidades</p>
      </div>
