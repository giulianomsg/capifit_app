...
const LoginPage = () => {
  ...
  useEffect(() => {
    if (isAuthenticated) {
      const redirectPath = location.state?.from?.pathname ?? '/dashboard-principal';
        ...
        <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-primary to-secondary p-12 text-white relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col justify-center max-w-md">
            ...
            <div className="space-y-6">
              <h2 className="text-3xl font-bold leading-tight">Transforme sua carreira como Personal Trainer</h2>
              <p className="text-white/90 text-lg leading-relaxed">
                Gerencie clientes, crie treinos personalizados e acompanhe resultados na plataforma fitness mais inteligente do
                Brasil.
              </p>
        ...
        <div className="flex-1 lg:w-1/2 flex items-center justify-center p-6 lg:p-12">
          <div className="w-full max-w-md space-y-8">
            ...
            <div className="text-center lg:text-left">
              <h2 className="text-2xl lg:text-3xl font-bold text-foreground mb-2">Bem-vindo de volta</h2>
            ...
            <div className="text-center pt-6 border-t border-border">
              ...
              <div className="flex justify-center space-x-4 mt-2">
                ...
                <button className="text-xs text-muted-foreground hover:text-foreground transition-colors">Suporte</button>
              </div>
            </div>
          </div>
        </div>
